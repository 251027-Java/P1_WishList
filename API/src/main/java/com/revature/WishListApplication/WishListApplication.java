...
public class WishListApplication {
    ...
    CommandLineRunner seedData (PasswordEncoder encoder, UserRepository userRepository,
        ...
        return args -> {
            ...
            var wi7 = new WishlistItem(i1, w4);
            var wi8 = new WishlistItem(i2, w4);
            var wi9 = new WishlistItem(i3, w4);
            var wi10 = new WishlistItem(i4, w4);
            wishlistItemRepository.saveAll(List.of(wi1, wi2, wi3, wi4, wi5, wi6, wi7, wi8, wi9, wi10));
        };
    }
